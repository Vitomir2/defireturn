 ...
 * /balance/:
 *   get:
 *     summary: Get the ERC20 balance of the provided wallet
 *     description: Get the exact ERC20 value owned by the provided EOA address.
 *     tags: [Wallet]
 *     parameters:
 *       - in: query
 *         name: wallet
 ...
 *         description: The current execution progress or result is returned.
 */
router.get("/balance/", walletController.walletERC20Balance);
